...
class App extends React.Component {
  ...
  loadpage = async () => {
      const { data } = await this.fetchRepos(this.state.user.login,this.state.page);
  ...
  render() {
    const { userDataError, reposError, loading, user, repos,page,pageSize } = this.state;
    const { match } = this.props;
